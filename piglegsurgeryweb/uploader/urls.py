...
urlpatterns = [
    ...
    path(
        "<str:filename_hash>/run_and_force_tracking/", views.run_and_force_tracking, name="run_and_force_tracking"
    ),  # used for debugging purposes
    ...
    path("run_collection_and_force_tracking/<int:collection_id>/", views.run_collection_force_tracking, name="run_collection_and_force_tracking"),
    ...
    path("stream_ith_video/<str:uploadedfile_hash>/<int:ith_video>", views.stream_video, name="stream_ith_video"),
