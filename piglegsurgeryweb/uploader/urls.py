...
urlpatterns = [
    ...
    path('<int:filename_id>/swap_is_microsurgery/', views.swap_is_microsurgery, name='swap_is_microsurgery'),
    path('web_report/<str:filename_hash>/', views.web_report, name='web_report'),
    path('owners_reports/<str:owner_hash>/', views.owners_reports_list, name='owners_reports_list'),  # used for debugging purposes
