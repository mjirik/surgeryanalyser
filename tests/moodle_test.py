...
def test_moodle_list():
    ...
    response = requests.post(
        f"http://{MOODLE_HOST}:{MOODLE_PORT}/login/token.php?moodlewsrestformat=json",
        params=query,
    )
    ...
    response = requests.post(
        f"http://{MOODLE_HOST}:{MOODLE_PORT}/webservice/rest/server.php?moodlewsrestformat=json",
        params=query,
    )
