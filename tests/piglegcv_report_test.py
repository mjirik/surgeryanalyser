...
def test_main_report_micro():
    ...
    test_data_dir = local_dir / "test_data/test_micro_SA_20230526-153002VID20230526111625.mp4"
    assert test_data_dir.exists(), "Unpack test_micro_SA_20230526-15300...zip into test_data directory "
...
def test_add_ruler_is_micro():
    ...
    ruler_adder = run_report.AddRulerInTheFrame(shape, pix_size_m=pix_size,
