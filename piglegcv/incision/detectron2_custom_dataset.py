...
cfg.merge_from_file(
    f"/storage/plzen1/home/{logname}/projects/detectron2/configs/COCO-Detection/faster_rcnn_R_50_FPN_3x.yaml"
)
...
cfg.DATASETS.TEST = (
    "fruits_nuts",
)  # you can (and should) register another dataset and put it here
